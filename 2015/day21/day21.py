...
def battle(hp, weapon, armour, ring1, ring2, boss, min_cost):
...
def puzzle(puzzle_input: list[str]) -> float | int:
        ...
        for armour in armour_lst:
            for ring1 in ring_lst:
                for ring2 in ring_lst:
                    min_cost = battle(hp, weapon, armour, ring1, ring2, boss, min_cost)
    return min_cost
